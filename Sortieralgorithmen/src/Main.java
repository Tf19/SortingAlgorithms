...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(QUICKSORT_CC + " - Quicksort (nebenläufig, " + QuicksortConcurrently.SIZE_THRESHOLD + " Elemente pro Thread)");
		...
		if (Integer.parseInt(enteredSortingProcess) == ALL) {
			...
			process.sort();
			System.out.println("Quicksort (nebenläufig):\t" + process.getSortingTime() / 1000000 + " ms\t" + QuicksortConcurrently.COMPLEXITY);
		} else {
